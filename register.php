...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Register || The circle Shop</title>
      ...
      <div class="row">
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="00000" name="address">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="thecircle@gmail.com" name="email">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
